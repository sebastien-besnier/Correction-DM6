# -*- coding: utf-8 -*-
"""
Created on Wed Feb 25 15:16:29 2015
...
derivative(5*X**3 - 6*X +3) #15*X**2 - 6
...
def sturm_sequence(P):
    ...
    """
    P_0,P_1=P,derivative(P)    
    L=[P_0,P_1]
    print L    
    i=1
    while L[i-1]%L[i]!=0 and L[i]!=0:
        L.append(-L[i-1]%L[i])
        i=i+1
    return L
