...
# Soit on utilise P.lead, soit on fait P[n] avec n=deg.P
       
# 3. Comment accéder au terme constant d'un polynôme P?
        
# P[0] renvoie le terme constant du polynome
...
# On utilise d'abord deg.P qui nous donnes le degré de P, si P est le polynome
#nul deg.P=0, puis on utilise P[0] et on doit avoir P[0]=0
...
P=Polynome([-1, 9,-6,1])
nb_roots_between(sturm_sequence(P), 0, 4)
