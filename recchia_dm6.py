...
# 0. Quel polynôme est construit par l'instruction P=Polynome([0,1,2,3])
P=Polynome([0,1,2,3])
P
3*X**3 + 2*X**2 + X
...
'Pour cela on peut utiliser P.lead et le résultat est immédiat. Ou bien rechercher P[P.deg]. Dans les deux cas, on a le coefficient dominant de polynome P'

# 3. Comment accéder au terme constant d'un polynôme P?
'On y accède grace à P[0]
...
N
P//N
'Resulats: 5/42*X**30 - 5/588*X**19 + 5/882*X**18 + 5/8232*X**8 - 5/6174*X**7 + 5/18522*X**6

# 5. Si P est un polynôme, comment tester que P est le polynôme nul?
'On tape P.deg et si P.deg=-1, alors il s agit du polynome nul.
